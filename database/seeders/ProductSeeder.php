...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
       ...
       foreach(['xanh','đỏ','tím','vàng','hồng'] as $item ){
      ...
      for ($i=0; $i < 1000; $i++) { 
        ...
        'sku'=> Str::random(8) . $i,
        'img_thumbnail'=>'https://canifa.com/img/1000/1500/resize/8/t/8th24s010-se472-1.webp',
      ...
      for ($i = 1; $i < 1001; $i++) { 
        ...
        ProductGallery::query()->insert([
            [
                ...
                'image' => 'https://canifa.com/img/1000/1500/resize/8/t/8th24s010-se472-l-1-u.webp',
            ],
            [
                'product_id' => $productID,
                'image' => 'https://canifa.com/img/1000/1500/resize/8/t/8th24s010-se472-l-1-u.webp',
